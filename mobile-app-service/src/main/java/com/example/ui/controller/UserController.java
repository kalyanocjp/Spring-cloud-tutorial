...
public class UserController {
	...
	public ResponseEntity<User> createUser(@Valid @RequestBody UserRequest userRequest) {
		User user = userService.createUserService(userRequest);
		usersCollection.put(user.getUserId(), user);
	...
	public ResponseEntity<String> updateUser(@PathVariable String userId, @RequestBody UpdateUser updateUser) {
		User user = usersCollection.get(userId);
		if (null != user) {
